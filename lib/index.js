...
var DEFAULT_VERIFY_FUNCTION = jwt.verify;
...
module.exports = function(options) {
  ...
  var verifyCallback = options.verify || DEFAULT_VERIFY_FUNCTION;
  ...
  var middleware = function(req, res, next) {
    ...
    async.waterfall([
      ...
      function verifyToken(secret, callback) {
        verifyCallback(token, secret, options, function(err, decoded) {
          if (err) {
